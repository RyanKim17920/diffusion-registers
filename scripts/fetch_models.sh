...
for m in kuleshov-group/mdlm-owt inclusionAI/LLaDA2.0-mini dllm-hub/Qwen3-0.6B-diffusion-mdlm-v0.1 Efficient-Large-Model/Fast_dLLM_v2_1.5B Dream-org/Dream-v0-Base-7B Qwen/Qwen2.5-7B; do
  echo "=== fetching $m ==="
